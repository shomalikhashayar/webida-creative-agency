...
<q-layout :view="rightLayout" class="gt-sm" v-if="$q.screen.gt.sm">
  ...
  <q-page-container>
    <q-page>
      ...
      <div class="bg-white">
        <h2 class="q-my-xl text-center text-secondary text-h3 no-letter-spacing text-weight-700">دیگر راه‌های ارتباطی با
                ...
                <q-card-section class="q-pa-xl">
                  <div class="row q-gutter-x-lg">
                    <div class="col">
                      <div class="q-gutter-y-sm">
                        <q-item-label class="no-letter-spacing text-grey-7 text-body1">نام و نام خانوادگی <span
                            class="text-primary">(ضروری)</span></q-item-label>
                        <q-input color="primary" hide-bottom-space v-model="username" dense required lazy-rules outlined
                          :rules="[(val) => val !== null && val !== '']"></q-input>
                      </div>
                    </div>
                    <div class="col">
                      <div class="q-gutter-y-sm">
                        <q-item-label class="no-letter-spacing text-grey-7 text-body1">شماره تماس <span
                            class="text-primary">(ضروری)</span></q-item-label>
                        <q-input color="primary" hide-bottom-space v-model="username" dense required lazy-rules outlined
                          :rules="[(val) => val !== null && val !== '']"></q-input>
                      </div>
                  ...
                  <div class="q-gutter-y-sm q-mt-lg">
                    <q-item-label class="no-letter-spacing text-grey-7 text-body1">جا متنی <span
                        class="text-primary">(ضروری)</span></q-item-label>
                    <q-input color="primary" v-model="textareaModel" outlined clearable type="textarea"></q-input>
                  </div>
                  <q-btn label="برسد به دستمان" icon="o_mail" color="primary" unelevated
            ...
            <q-item>
              <div class="row items-center">
                ...
                <q-item-section class="column justify-center q-gutter-y-sm q-ml-md">
                  ...
                  <p class="no-margin text-dark text-body1 text-weight-400 no-letter-spacing">تیم پشتیبانی وبیدا برای
                    هر گونه
              ...
              <div class="row items-center">
                ...
                <q-item-section class="column justify-center q-gutter-y-sm q-ml-md">
                  ...
                  <q-btn unelevated style="width:124px" color="primary" label="پشتیبانی" icon="o_perm_phone_msg">
                    <q-menu fit transition-show="jump-down" transition-hide="jump-up" style="width:240px"
                      :offset="[0, 10]">
                      <q-list padding>
