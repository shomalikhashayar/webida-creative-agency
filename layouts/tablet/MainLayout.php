<div class="sm" v-if="$q.screen.sm">
  <q-header unelevated bordered class="bg-accent">
    ...
    <div class="container">
      <q-toolbar class="row justify-between items-center q-px-none q-py-lg bg-accent">
        <div class="flex link-on-hover">
          <a class="text-h2 no-letter-spacing text-secondary no-decoration text-weight-900"
        ...
        <div class="row items-center q-gutter-sm">
          <q-btn @click="toggleDrawer" unelevated round dense size="30px" color="primary" text-color="white"><q-icon
              size="md" name="o_lunch_dining"></q-icon></q-btn>
          <q-btn unelevated dense size="30px" color="primary" text-color="white" round>
  ...
  <q-footer class="q-py-xl bg-secondary">
    <div class="column q-py-xl container bg-secondary">
        ...
        <div class="column q-gutter-md">
          <div class="row items-center link-on-hover">
            <q-icon name="circle" size="12px" class="q-mr-md text-primary"></q-icon><a
              class="text-h3 text-weight-300 text-white no-decoration"
      ...
      <div class="col-4">
        <p class="text-h1 text-weight-900 text-white q-mb-lg">آخرین مقالات منتشر شده</p>
        <div class="column q-gutter-lg link-on-hover">
          ...
          foreach ($latest_posts as $post) {
            setup_postdata($post);
            echo '<a class="text-h3 text-weight-300 text-white no-decoration" href="' . get_permalink() . '">' . get_the_title() . '</a>';
          }
      ...
      <q-separator color="blue-grey-13" class="q-my-xl"></q-separator>
      <div class="col-4">
        <p class="text-h1 text-weight-900 text-white q-mb-lg">راه های ارتباطی شما با ما</p>
        ...
        <div class="row justify-between items-center q-py-md link-on-hover">
          <a class="text-h3 text-weight-300 text-white no-decoration" href="tel:09338603196">09338603196</a>
          <a class="text-h3 text-weight-300 text-white no-decoration" href="mailto:info@webida.ir">info@webida.ir</a>
        </div>

        <div class="row justify-between items-center q-py-md link-on-hover">
          <a class="text-h3 text-weight-300 text-white no-decoration" href="tel:09100854885">09100854885</a>
          <a class="text-h3 text-weight-300 text-white no-decoration" href="tel:09215848578">09215848578</a>
        </div>

        <q-card class="no-shadow no-border q-mt-md q-pb-md q-radius-sm bg-blue-grey-8">

          <q-card-section>
            <p class="text-center text-h3 text-weight-300">با ما در شبکه‌های اجتماعی در ارتباط باشید</p>
