<div class="bg-accent">
    <div class="container contact-us-hero row items-center">
        ...
        <div class="q-ml-xl" style="width: 600px">
            ...
            <h2 class="line-height-sm no-letter-spacing text-body1 text-weight-400 text-dark">
                تیم وبیدا، صمیمانه تمایل دارد انتقادات و پیشنهادات سازنده شما را دریافت کند.
            </h2>
            <p class="line-height-sm no-letter-spacing text-body1 text-weight-700 text-primary">
                یک دکمه در گوشه راست سایت مشاهده می‌کنید که می‌توانید با کلیک بر روی آن با ما به صورت آنلاین ارتباط
                برقرار
                کنید.
            </p>
        </div>
