                        ...
                        <div class="row q-gutter-x-lg">
                            <div class="col">
                                <div class="q-gutter-y-sm">
                                    ...
                                    <q-input name="name" required color="primary" hide-bottom-space v-model="fullName"
                                        dense required lazy-rules outlined
                                        :rules="[(val) => val !== null && val !== '']"></q-input>
                                </div>
                            </div>
                            <div class="col">
                                <div class="q-gutter-y-sm">
                                    <q-item-label name="phone" required
                                        class="no-letter-spacing text-grey-7 text-body1">شماره تماس <span
                                            class="text-primary">(ضروری)</span></q-item-label>
                                    <q-input color="primary" hide-bottom-space v-model="phoneNumber" dense required
                            ...
                            <q-menu fit transition-show="jump-down" transition-hide="jump-up" style="width:240px"
                                ...
                                <q-list padding>
                                    <q-item class="row items-center q-py-sm" clickable href="tel:09338603196">
                                        <div>
                                            <q-item-section avatar>
                                                <q-avatar icon="o_person" size="md" text-color="white"
                                                    color="primary" />
                                            </q-item-section>
                                        </div>
