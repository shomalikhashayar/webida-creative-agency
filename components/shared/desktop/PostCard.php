  ...
  <q-card bordered style="min-height:280px"
    ...
    <q-card-section class="q-pa-none">
      <?php if (has_post_thumbnail()): ?>
        ...
        ?>
        <q-img spinner-color="primary" fit="cover" class="q-mb-sm q-radius-xs" src="<?php the_post_thumbnail_url(); ?>"
          :ratio="1" alt="<?php echo esc_attr($alt_text); ?>" height="130px"></q-img>
      <?php endif ?>
      ...
      <h3 class="text-body3 no-decoration text-weight-900 text-grey-8">
        <?php the_title(); ?>
      </h3>
    </q-card-section>
    <q-card-section class="q-pa-none">
