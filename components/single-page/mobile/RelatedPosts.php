<div class="xs">
    ...
    <a class="no-decoration" href="' . $permalink . '">
        <q-card bordered class="on-hover-primary-1 full-height column justify-between post-card q-radius-sm no-shadow q-pa-md">
            <q-card-section class="q-pa-none">';
            if (!empty($thumbnail_url)) {
                echo '<q-img style="border-radius:6px" class="q-mb-sm" src="' . $thumbnail_url . '" :ratio="4/3" alt="" height="150px"></q-img>';
            }
