<div class="bg-white ">
   <div class="container">
      <h2 class="q-my-xl text-center text-secondary text-h3 no-letter-spacing text-weight-800">
      ...
      <div class="bg-white q-pb-md">
         ...
         <div class="column items-center q-mb-xl">
            ...
            <p class="text-body1 q-pt-xs no-margin text-weight-700 line-height-sm text-center text-dark ">
