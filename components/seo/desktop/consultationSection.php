<div class="bg-primary">
    <div class="container">
        <div class="row">
            <div class="col-7 column q-gutter-y-sm justify-center" style="padding-left: 125px;">
                <h3 class=" text-white text-h4 no-letter-spacing no-margin text-weight-900">
                    درخواست مشاوره سئو دارم
                </h3>
                <p class="no-letter-spacing text-body1 text-weight-400 line-height-sm text-white">
