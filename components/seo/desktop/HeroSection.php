            ...
            <div class="col-5 q-gutter-y-lg">
                ...
                <div class="row justify-start q-gutter-x-sm">
                    <q-btn @click="" unelevated rounded label="مشاوره سئو"
                        class="webida-primary text-white  no-letter-spacing text-body2 text-weight-regular " padding="10px 24px">

                    </q-btn>
                    <q-btn @click="ConsultantModal = true" unelevated flat rounded label="خرید بک لینک"
                        class="text-primary text-body2  no-letter-spacing text-weight-regular white-btn"
                        padding="10px 24px">
                    </q-btn>
                </div>
