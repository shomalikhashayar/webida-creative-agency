<div class="bg-grey-4 ">
   <div class="container type-Of-Link-Building-Section">
      <h2 class="q-mb-md text-center text-secondary text-h3 no-letter-spacing text-weight-900">
         انواع بک‌ لینک
      </h2>
      <p class="text-body1 no-margin text-weight-400 text-center line-height-sm text-dark no-letter-spacing">
         بک‌لینک‌هایی که در وبیدا ارائه می‌شوند، همگی از سایت‌های معتبری هستند و به دو دسته کلی تقسیم می‌شوند:
      </p>
      <div class="fit row type-link-building-card-container">
         ...
         <div class="col bg-white column no-wrap type-link-building-card ">
            ...
            <p class="text-body1 no-margin text-weight-400 line-height-sm text-dark no-letter-spacing">
