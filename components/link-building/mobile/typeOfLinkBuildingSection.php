<div class="bg-grey-4 ">
   <div class="container type-Of-Link-Building-Section">
      <h2 class="no-margin q-py-lg text-center text-secondary text-h3 no-letter-spacing text-weight-900">
         انواع بک‌ لینک
      </h2>
      <p class="text-body1 q-pb-xl no-margin text-weight-500 text-center line-height-sm text-dark ">
