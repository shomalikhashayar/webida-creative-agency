    ...
    <div class="column q-gutter-y-lg">
      ...
      <q-card class="full-width services-card q-pa-md no-shadow q-radius-sm on-hover-primary-1">
        ...
        <q-card-section class="q-pt-none">
          ...
          <p class="text-body1 no-letter-spacing text-secondary text-weight-400">سفری به دنیای جذاب رابط و تجربه کاربری:
            جاذبه‌ای نوآورانه
            برای همهٔ تجربه‌ها</p>
        </q-card-section>

        <q-card-section class="q-pt-none">
          <q-img src="<?php echo get_template_directory_uri(); ?>/assets/images/webida-user-interface-design.svg"
            alt="" />
        </q-card-section>
