<q-carousel v-model="slide" transition-prev="jump-right" infinite @mouseenter="autoplay = false"
  ...
  <q-carousel-slide :name="1" class="flex justify-center q-pa-none  items-center webida-accent" v-if="$q.screen.gt.md" >
  ...
  <q-carousel-slide :name="1" class="flex justify-center q-pa-none  items-center webida-accent" v-if="$q.screen.md">
    <div class="container row">
      <div class="col row justify-between">
        <div class="row">
        <img src="<?php echo get_template_directory_uri(); ?>/assets/images/R.I.P.svg" alt="" style="width:150px">
          <h1 style="width:250px; line-height: 72px; font-size:64px;" class="animate-characters q-pl-md text-weight-900 text-secondary">
            آژانس خلاقیت وبیدا</h1>
  ...
  <q-carousel-slide :name="2" class="row justify-center items-center bg-accent">
    <div class=" column items-center" style="margin-bottom:54px">
