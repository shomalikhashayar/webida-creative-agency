<q-card class="full-width services-card q-pa-lg no-shadow q-radius-sm on-hover-primary-1">
  ...
  <q-card-section class="q-pa-none">
    <h2 class="text-h5 line-height-sm q-pb-sm no-margin link-on-hover"><a
        class="text-h5 line-height-sm text-secondary text-weight-900 text-secondary no-decoration"
        href="<?php echo esc_html(get_site_url()) . '/website-design'; ?>">طراحی سایت</a></h2>
    <p class="text-body2 no-letter-spacing text-secondary text-weight-300">هویت برندتان را در دنیای دیجیتال به
      نمایش بگذارید</p>
  </q-card-section>
...
<q-card class="full-width services-card q-pa-lg no-shadow q-radius-sm on-hover-primary-1">
  ...
  <q-card-section class="q-pa-none">
    ...
    <p class="text-body2 no-letter-spacing text-secondary text-weight-300">سئو = بازدید کننده بیشتر = رتبه بندی بهتر =
      فروش بیشتر</p>
  </q-card-section>
...
<q-card class="full-width services-card q-pa-lg no-shadow q-radius-sm on-hover-primary-1">
  ...
  <q-card-section class="q-pa-none">
    ...
    <p class="text-body2 no-letter-spacing text-secondary text-weight-300">مقالات تخصصی و آموزشی، محتوای وبسایت، بلاگ
...
<q-card class="full-width services-card q-pa-lg no-shadow q-radius-sm on-hover-primary-1">
  ...
  <q-card-section class="q-pa-none">
    ...
    <p class="text-body2 no-letter-spacing text-secondary text-weight-300">جذب ترافیک هدفمند، بهبود دیده شدن در نتایج
...
<q-card class="full-width services-card q-pa-lg no-shadow q-radius-sm on-hover-primary-1">
  ...
  <q-card-section class="q-pa-none">
    ...
    <p class="text-body2 no-letter-spacing text-secondary text-weight-300">سفری به دنیای رابط کاربری: جاذبه‌ای نوآورانه
...
<q-card class="full-width services-card q-pa-lg no-shadow q-radius-sm on-hover-primary-1">
  ...
  <q-card-section class="q-pa-none">
    ...
    <p class="text-body2 no-letter-spacing text-secondary text-weight-300">بنرهای خلاقانه‌تر برای تبلیغاتتان افزایش فروش
